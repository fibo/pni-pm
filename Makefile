# This Makefile is for the PNI extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PNI.pm]
#     AUTHOR => q[G. Casati <fibo@cpan.org>]
#     BUILD_REQUIRES => {  }
#     NAME => q[PNI]
#     PREREQ_PM => { Module::Pluggable=>q[0], Scalar::Util=>q[0], File::Spec=>q[0], Time::HiRes=>q[0], Exporter=>q[0], Carp=>q[0], Test::More=>q[0], File::Find=>q[0], File::Temp=>q[0.22], JSON=>q[2.51] }
#     VERSION_FROM => q[lib/PNI.pm]
...
TO_INST_PM = lib/PNI.pm \
	...
	lib/PNI/Line.pm \
	lib/PNI/Node.pm \
	lib/PNI/Node/PNI/Root.pm \
	lib/PNI/Node/PNI/Scenario.pm \
	lib/PNI/Out.pm \
	lib/PNI/Point.pm \
	lib/PNI/Rectangle.pm \
	lib/PNI/Scenario.pm \
	lib/PNI/Set.pm \
	lib/PNI/Slot.pm

PM_TO_BLIB = lib/PNI/Comment.pm \
	blib\lib\PNI\Comment.pm \
	lib/PNI/Line.pm \
	blib\lib\PNI\Line.pm \
	lib/PNI/Set.pm \
	blib\lib\PNI\Set.pm \
	lib/PNI/File.pm \
	blib\lib\PNI\File.pm \
	lib/PNI/Finder.pm \
	blib\lib\PNI\Finder.pm \
	lib/PNI/Scenario.pm \
	blib\lib\PNI\Scenario.pm \
	lib/PNI/Node/PNI/Root.pm \
	blib\lib\PNI\Node\PNI\Root.pm \
	lib/PNI/Node/PNI/Scenario.pm \
	blib\lib\PNI\Node\PNI\Scenario.pm \
	lib/PNI/Point.pm \
	blib\lib\PNI\Point.pm \
	lib/PNI.pm \
	blib\lib\PNI.pm \
	lib/PNI/Node.pm \
	blib\lib\PNI\Node.pm \
	lib/PNI/Out.pm \
	blib\lib\PNI\Out.pm \
	lib/PNI/Elem.pm \
	blib\lib\PNI\Elem.pm \
	lib/PNI/Slot.pm \
	blib\lib\PNI\Slot.pm \
	lib/PNI/In.pm \
	blib\lib\PNI\In.pm \
	lib/PNI/Edge.pm \
	blib\lib\PNI\Edge.pm \
	lib/PNI/Rectangle.pm \
	blib\lib\PNI\Rectangle.pm
...
PNI.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"PNI\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               PNI" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.20" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Perl Node Interface" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - G. Casati <fibo@cpan.org>" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "    JSON:               2.51" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl Node Interface</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>G. Casati &lt;fibo@cpan.org&gt;</AUTHOR>" >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"JSON::\" VERSION=\"2.51\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/PNI/Comment.pm blib\lib\PNI\Comment.pm \
	  lib/PNI/Line.pm blib\lib\PNI\Line.pm \
	  lib/PNI/Set.pm blib\lib\PNI\Set.pm \
	  lib/PNI/File.pm blib\lib\PNI\File.pm \
	  lib/PNI/Finder.pm blib\lib\PNI\Finder.pm \
	  lib/PNI/Scenario.pm blib\lib\PNI\Scenario.pm \
	  lib/PNI/Node/PNI/Root.pm blib\lib\PNI\Node\PNI\Root.pm \
	  lib/PNI/Node/PNI/Scenario.pm blib\lib\PNI\Node\PNI\Scenario.pm \
	  lib/PNI/Point.pm blib\lib\PNI\Point.pm \
	  lib/PNI.pm blib\lib\PNI.pm \
	  lib/PNI/Node.pm blib\lib\PNI\Node.pm \
	  lib/PNI/Out.pm blib\lib\PNI\Out.pm \
	  lib/PNI/Elem.pm blib\lib\PNI\Elem.pm \
	  lib/PNI/Slot.pm blib\lib\PNI\Slot.pm \
	  lib/PNI/In.pm blib\lib\PNI\In.pm \
	  lib/PNI/Edge.pm blib\lib\PNI\Edge.pm \
	  lib/PNI/Rectangle.pm blib\lib\PNI\Rectangle.pm 
