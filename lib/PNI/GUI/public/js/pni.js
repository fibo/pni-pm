    ...
    addNode: function(requestData) { //[
        ...
        $j.ajax({
            ...
            success: function(responseData) {
                ...
                if( arg.type == "Perldata::Scalar" ) {
                    node = new PNI.NodePerldataScalar(arg);
                }
                else {
...
// PNI.NodePerldataScalar //[

PNI.NodePerldataScalar = function(arg) {
    ...
    .addClass("pni-node-perldata-scalar")
    .draggable()
    .attr('id',this.id)
...
PNI.NodePerldataScalar.prototype = { }; 
