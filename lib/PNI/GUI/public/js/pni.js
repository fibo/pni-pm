...
PNI.Scenario = function(arg) { 
    ...
    this.nodeInspector = new PNI.NodeInspector();
    ...
    this.$container.click( function(e) {
        ...
        if( that.nodeInspector.visible ) {
            that.nodeInspector.hide();
            return;
        }
...
PNI.NodeInspector = function(arg) {

    this.$container = $j("#node-inspector");

}

PNI.NodeInspector.prototype = {
