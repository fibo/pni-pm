...
PNI.View = function() { //[
    ...
    /*
    var $canvas = this.$canvas = $j('<canvas></canvas>')
    .attr('height',this.$container.height())
    .attr('width',this.$container.width())
    .appendTo(this.$container)
    ;

    // TODO per ora faccio cosi, TEMPORARY
...
PNI.Node = function(arg) { //[
    ...
    var $scenario = this.$scenario = arg.$scenario;
