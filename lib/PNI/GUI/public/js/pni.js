...
// prima era
 ...
 //
 // vedi se va bene, voglio che si possa fare l' override, cioe se la classe
 // figlia ha gia il metodo o l' attributo, non lo deve ereditare.

            if ( superClass.prototype.hasOwnProperty(key) && ! subClass.prototype.hasOwnProperty(key) ) {
...
PNI.Scenario = function(arg) { //[
    ...
    console.log( evt.charCode );
        ...
        // TODO provvisorio: per ora shift T fa il run task
        if( evt.charCode == 84 ) {
