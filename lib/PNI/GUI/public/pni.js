...
PNI.CanvasItem.Background = function(arg) { //[
    ...
    // TODO solo per fare un test
    var addNode = function(arg){

        arg.centerX = arg.x
        arg.centerY = arg.y

        arg.inSlots = [{in1:"bar"},{in2:"foo"}]; //[ {in1:"foo"}, {in2:"foo"}, {in3:"foo"}, {in4:"bar"} ]

        var node = new PNI.CanvasWidget.Node(arg);
    }

    this.on("click",addNode)
...
PNI.Canvas = function(arg) { //[
    ...
    // TODO da cachare altrimenti JQuery ogni volta fa scansione del DOM
    $('#'+canvasId).click( function(e) { //[
        ...
        currentItem.emit("click",{x:x,y:y,canvas:_this})
