...
PNI.EventEmitter = function() {this.foo="bar"} 

//PNI.EventEmitter.prototype = new Object()

//PNI.EventEmitter.prototype.constructor = PNI.EventEmitter

//PNI.EventEmitter.prototype.parent = Object.prototype

PNI.EventEmitter.prototype.init = function (arg) { 
...
PNI.EventEmitter.prototype.doNothing = function () {}
...
PNI.CanvasItem = function() { PNI.EventEmitter.call(this) }
...
PNI.CanvasItem.Rectangle.prototype.draw = function() { //[
...
PNI.Canvas.prototype.init = function (arg) { //[
...
PNI.Window = function(arg) { //[
    ...
    var r = canvas.addItem("rectangle",{centerX:30,centerY:40,height:100,width:200})
