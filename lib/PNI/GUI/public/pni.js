...
PNI.CanvasItem = function() { 
    ...
    this.off = function(eventType) {delete actionForEvent[eventType]}
    ...
    this.on = function(eventType,action) { //[
        ...
        actionForEvent[eventType] = action
...
PNI.CanvasItem.prototype = new PNI.CanvasItem()
...
PNI.CanvasItem.Background.prototype.containsPoint = function(x,y) { //[
...
PNI.CanvasItem.Background.prototype.draw = function(c) {}
...
PNI.Window = function(arg) { //[
    ...
    var inSlotsJSON = [{name:"in1"},{name:"in2",data:["ok","ok2"]},{name:"in3",data:3},{name:"in4"}]
